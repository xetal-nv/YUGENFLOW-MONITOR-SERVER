...
func main() {
	...
	case 1:
		//go sensormodels.SensorModel(0, 7000, 5, []int{-1, 1}, []byte{'a', 'b', 'c', '1', '2', '1'})
		go sensormodels.SensorModel(1, 7000, 30, []int{-1, 1}, []byte{'a', 'b', 'c', '1', '2', '2'})
		//go sensormodels.SensorModel(20, 5000, 5, []int{-1, 1}, []byte{'a', 'b', 'c', '1', '2', '3'})
